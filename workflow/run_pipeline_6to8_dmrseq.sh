#!/usr/bin/env bash
# ==============================================================================
# Script: run_pipeline_6to8_dmrseq.sh
# Purpose: Run R dmrseq analysis pipeline (Steps 6, 7-dmrseq, 8)
#          Import BSseq → dmrseq Analysis → Visualization
...
echo "=============================================="
echo " R dmrseq Analysis Pipeline (Steps 6-8)"
echo " Started: $(date)"
echo "=============================================="
...
echo ""
echo "[STEP 7/8] dmrseq - Differential Methylation Region Analysis"
echo "----------------------------------------------"
Rscript scripts/07_dmrseq.R
...
echo ""
echo "=============================================="
echo " Pipeline 6-8 (dmrseq) COMPLETE!"
echo " Finished: $(date)"
echo ""
echo " Results:"
echo "   - HDF5 BSseq: results/r_objects/dss_h5_store/"
echo "   - DMR Results: results/dmrseq_results/"
